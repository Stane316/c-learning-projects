/*
 * =============================================================================
 * Projet     : Maximum d'un tableau de 10 entiers
 * Fichier    : main.c
...
int main() {
    int tab[TAILLE], i, max, pos; char c, continuer;
    do {
        printf("\n===========================================\n");
        printf("  MAXIMUM D'UN TABLEAU DE %d ENTIERS\n", TAILLE);
        printf("===========================================\n\n");
        for (i=0; i<TAILLE; i++) {
            while (1) {
                printf("  tab[%d] : ", i);
        ...
        max=tab[0]; pos=0;
        for (i=1; i<TAILLE; i++) if (tab[i]>max) { max=tab[i]; pos=i; }
